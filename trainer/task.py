...
class CycleGAN():
    ...
    def input_setup(self):
        ...
        filenames_A = tf.train.match_filenames_once("./data/horse2zebra/trainA/*.jpg")
        self.queue_length_A = tf.size(filenames_A)
        filenames_B = tf.train.match_filenames_once("./data/horse2zebra/trainB/*.jpg")
    ...
    def loss_calc(self):
        ...
        *_summ -> Summary variables for above loss functions'''
        ...
        cyc_loss = tf.reduce_mean(tf.abs(self.input_A - self.cyc_A)) + \
